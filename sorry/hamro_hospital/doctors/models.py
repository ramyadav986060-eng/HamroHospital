...
class Doctor(models.Model):
    ...
    extension_new_fee = models.DecimalField(max_digits=10, decimal_places=2, default=0, blank=True)
    extension_old_fee = models.DecimalField(max_digits=10, decimal_places=2, default=0, blank=True)
    ...
    extension_morning_quota = models.PositiveIntegerField(default=0, blank=True)
    ...
    extension_afternoon_quota = models.PositiveIntegerField(default=0, blank=True)
