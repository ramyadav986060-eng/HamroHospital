...
def counter_report(request):
    ...
    if request.GET.get('export') == 'excel':
        ...
        return export_rows_to_excel(['Bill #', 'Patient', 'Cashier', 'Method', 'Total', 'Date'], rows, 'counter_report.xlsx', 'Cash Counter')
...
def pharmacy_report(request):
    ...
    if request.GET.get('export') == 'excel':
        ...
        return export_rows_to_excel(['Sale #', 'Patient', 'Method', 'Total', 'Date'], rows, 'pharmacy_report.xlsx', 'Pharmacy')
...
def laboratory_report(request):
    ...
    if request.GET.get('export') == 'excel':
        ...
        return export_rows_to_excel(['Test', 'Patient', 'Status', 'Requested At'], rows, 'laboratory_report.xlsx', 'Laboratory')
...
def nursing_report(request):
    ...
    if request.GET.get('export') == 'excel':
        ...
        return export_rows_to_excel(['Patient', 'Note Type', 'Recorded By', 'Recorded At'], rows, 'nursing_report.xlsx', 'Nursing')
...
def ot_report(request):
    ...
    if request.GET.get('export') == 'excel':
        ...
        return export_rows_to_excel(['Surgery #', 'Patient', 'Surgery', 'Surgeon', 'Status', 'Scheduled', 'Charge'], rows, 'ot_report.xlsx', 'Operation Theatre')
...
def blood_bank_report(request):
    ...
    if request.GET.get('export') == 'excel':
        ...
        return export_rows_to_excel(['Bag #', 'Group', 'Component', 'Qty (ml)', 'Status', 'Collected', 'Expires'], rows, 'blood_bank_report.xlsx', 'Blood Bank')
